...
alias vpn-canonical='sudo openvpn --mute-replay-warnings ~/.sesame/us-nobuto.conf'
alias vpn-canonical-global='sudo openvpn --mute-replay-warnings ~/.sesame/us-nobuto-global.conf'
alias vpn-canonical-tcp443='sudo openvpn --mute-replay-warnings ~/.sesame/us-nobuto-tcp443.conf'
alias vpn-canonical-tcp443-global='sudo openvpn --mute-replay-warnings ~/.sesame/us-nobuto-tcp443-global.conf'
